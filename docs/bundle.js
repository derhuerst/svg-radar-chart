...
var toHTML = require('virtual-dom-stringify');
var radar = require('..');
var smoothing = require('../smoothing');

var columns = document.querySelector('#demo-columns');
var data = document.querySelector('#demo-data');
var scales = document.querySelector('#demo-scales');
var axes = document.querySelector('#demo-axes');
var tension = document.querySelector('#demo-smoothing');

var opt = {
	shapeProps: function shapeProps(data) {
		return {
			className: 'shape',
			fill: data.color,
			stroke: data.color
...
var render = function render() {
	var c = safeEval(columns.value);
	var d = safeEval(data.value);
	var s = +scales.value;
	var a = axes.checked;
	var sm = +tension.value;
...
var asyncRender = function asyncRender() {
...
},{"..":2,"../smoothing":43,"safe-eval":20,"virtual-dom-stringify":27}],2:[function(require,module,exports){
'use strict';
...
},{"virtual-dom/h":28}],3:[function(require,module,exports){
"use strict";
...
},{"../noop":10,"./cardinal":6}],8:[function(require,module,exports){
"use strict";
...
},{"./constant":5,"./curve/linear":8,"./point":11,"d3-path":4}],10:[function(require,module,exports){
"use strict";
...
},{"sentence-case":21}],20:[function(require,module,exports){
'use strict';
...
},{"vm":41}],21:[function(require,module,exports){
'use strict';
...
},{"./vendor/camel-case-regexp":22,"./vendor/non-word-regexp":23,"./vendor/trailing-digit-regexp":24,"lower-case":18}],22:[function(require,module,exports){
"use strict";
...
module.exports = function stringify(node, parent, options) {
  ...
  if (arguments.length === 2 && (typeof parent === 'undefined' ? 'undefined' : _typeof(parent)) === 'object' && !parent.tagName) {
    options = parent;
    parent = null;
  }
  ...
  if (isVNode(node)) {
    ...
    for (var key in properties) {
      ...
      if (prop && prop !== 'innerHTML') {
        if ((typeof attrVal === 'undefined' ? 'undefined' : _typeof(attrVal)) === 'object' && key !== 'style') {
...
},{"./self-closing-tags":26,"he":13,"html-attributes":14,"param-case":19,"svg-attributes":25,"virtual-dom/vnode/is-thunk":33,"virtual-dom/vnode/is-vnode":35,"virtual-dom/vnode/is-vtext":36}],28:[function(require,module,exports){
"use strict";
...
},{"./virtual-hyperscript/index.js":31}],29:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-thunk":33,"../vnode/is-vhook":34,"../vnode/is-vnode":35,"../vnode/is-vtext":36,"../vnode/is-widget":37,"../vnode/vnode.js":39,"../vnode/vtext.js":40,"./hooks/ev-hook.js":29,"./hooks/soft-set-hook.js":30,"./parse-tag.js":32,"x-is-array":42}],32:[function(require,module,exports){
'use strict';
...
},{"indexof":15}],42:[function(require,module,exports){
"use strict";
...
var line = require('d3-shape/src/line').default;
var cardinal = require('d3-shape/src/curve/cardinalClosed').default;

var points = function points() {
	var tension = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : .3;
...
},{"d3-shape/src/curve/cardinalClosed":7,"d3-shape/src/line":9}]},{},[1]);
